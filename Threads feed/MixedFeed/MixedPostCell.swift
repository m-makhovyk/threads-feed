...
class MixedPostCell: UICollectionViewCell {
  ...
  private let attachmentsView = MixedAttachmentsView()
  ...
  func configure(with post: MixedPost) {
  ...
  private func attachmentHeight(for attachments: [MixedAttachment]) -> CGFloat {
